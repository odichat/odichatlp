    ...
    <div class="mx-auto max-w-7xl pt-10 pb-24 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-40">
      <div class="px-6 lg:px-0 lg:pt-4">
        <div class="mx-auto max-w-2xl">
          <div class="max-w-lg">
            <!-- <img class="h-11" src="https://odisea.nyc3.cdn.digitaloceanspaces.com/assets/logo.svg" alt="Odichat"> -->
            <div class="mt-24 sm:mt-32 lg:mt-16">
              <a href="#" class="inline-flex space-x-6">
                <span class="badge badge-outline badge-primary">Closed Beta</span>
              </a>
            </div>
            <h1 class="mt-10 text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">AI Agents into WhatsApp Business</h1>
      ...
      <div class="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen shadow-lg md:rounded-3xl">
        <img src="https://plus.unsplash.com/premium_photo-1682125273124-e0d7229d01f2?q=80&w=1760&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="md:rounded-3xl" />
      </div>
    </div>
